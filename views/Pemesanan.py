...
# --- GENERAL SETTINGS ---
STRIPE_CHECKOUT = "https://app.sandbox.midtrans.com/payment-links/1747395048117"
...
with left_col:
    ...
    st.markdown(
      f'<a href="{STRIPE_CHECKOUT}" class="button">👉 Pesan Sekarang</a>',
        unsafe_allow_html=True,
    )
with right_col:
    product_image = Image.open(ASSETS_DIR / "Produk.png")
